<?php
	...
	function db_open() {
		...
		try {
			if ($dbtype == 'mysql') {
				$hostname = '127.0.0.1';
				$username = 'hanlyorg_cbid';
				$password = '********';
				return new PDO("mysql:host=$hostname;dbname=hanlyorg_cb", $username, $password);
			} else {
...
<html>
	...
	<body>
		...
		<br />
		<br />
		<h5><font color=White>Receive email updates when your favorite items are up for auction!</font></h5>
		<h4><a href="http://sloppymcnubble.com/cbid/notifier_signup.php">Click here</a> to sign up</h4>
		<h4><a href="http://sloppymcnubble.com/cbid/cbid_watcher.php">Click here</a> to log in</h4>
		<br />
		<br />		
		<?php
		if ($issearch != ''){
