...
<html>
	<head>
		...
		<script src="js/elycharts.min.js" type="text/javascript"></script>
	...
	<body>
		<table width="100%">
		<tr>
			<td width="100px"> <a href="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>"><img src="img/Cigar_small.png" border="0"></a> </td>
			<td> <h2><center>CigarBid Completed Auction Search</center></h2> </td>
			<td width="100px"> <a href="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>"><img src="img/Cigar_small2.png" border="0"></a> </td>
		</tr>
		<tr></table>
		<center>
...
<?php
	} elseif ($output = 'CHROME_PLUGIN') {
?>
<html>
	<head>
		<title>Cbid Completed Auctions</title>
		<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
		<link rel=stylesheet href=plugin_style.css type=text/css>
		<script src="js/jquery-1.7.min.js" type="text/javascript"></script>
		<script src="js/raphael.js" type="text/javascript"></script>
		<script src="js/elycharts.min.js" type="text/javascript"></script>
		<script src="js/jquery.tablesorter.js" type="text/javascript"></script>
	...
	<body>
		...
		<?php
			if ($txttype == 'items') {
			?>
				<div id="chart" class="hidden" style="width: 90%; height: 150px; margin: 0 auto;"></div>
				<script type="text/javascript">
					drawChart();
				<?php
					$ua=getBrowser();
